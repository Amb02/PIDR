...
public class CombinationsHandler{
  public static final int GENERATED_FILES_LIMIT = 1000;
  ...
  private void ParseCombinations(){
    ...
    if (numberOfFiles > 1 && numberOfFiles < GENERATED_FILES_LIMIT){
      System.out.println("number of files to generate : " + numberOfFiles);
