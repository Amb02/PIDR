...
public interface ProverifVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link ProverifParser#nidecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNidecl(ProverifParser.NideclContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link ProverifParser#proverifOptionsFree}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitProverifOptionsFree(ProverifParser.ProverifOptionsFreeContext ctx);
	/**
	 * Visit a parse tree produced by {@link ProverifParser#proverifOptionsFun}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitProverifOptionsFun(ProverifParser.ProverifOptionsFunContext ctx);
	/**
	 * Visit a parse tree produced by {@link ProverifParser#proverifOptionsPred}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitProverifOptionsPred(ProverifParser.ProverifOptionsPredContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link ProverifParser#optionfun}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOptionfun(ProverifParser.OptionfunContext ctx);
	/**
	 * Visit a parse tree produced by {@link ProverifParser#optionpred}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOptionpred(ProverifParser.OptionpredContext ctx);
	/**
