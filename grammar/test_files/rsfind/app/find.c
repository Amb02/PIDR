...
int print_file (char * path, option_t * arguments [ARGUMENTS_NUMBER], int sortie) {
  ...
  if (is_set(arguments[PROVERIF]) || is_set(arguments[EXEC_CMD]) || is_set(arguments[LONG_LISTING_ALIGNED])) {
...
int rsfind (option_t * arguments [ARGUMENTS_NUMBER]) {
  ...
  if (is_set(arguments[PROVERIF]) || is_set(arguments[EXEC_CMD]) || is_set(arguments[LONG_LISTING_ALIGNED])) error = remove_file();
...
int should_display_long_listing_aligned (option_t * arguments [ARGUMENTS_NUMBER]) {
  return (is_set(arguments[LONG_LISTING_ALIGNED]) && !is_set(arguments[EXEC_CMD]))
    ...
    || (is_set(arguments[LONG_LISTING_ALIGNED]) && is_set(arguments[PROVERIF]) && is_set(arguments[PRINT])); 
}
