// $ANTLR 3.5.2 proverif.g 2019-02-27 07:07:44
...
public class proverifParser extends Parser {
	...
	@Override public String getGrammarFileName() { return "proverif.g"; }



	// $ANTLR start "programme"
	// proverif.g:8:1: programme : ( declaration )* 'process' process ;
	public final void programme() throws RecognitionException {
		try {
			// proverif.g:9:2: ( ( declaration )* 'process' process )
			// proverif.g:9:4: ( declaration )* 'process' process
			{
			// proverif.g:9:4: ( declaration )*
			loop1:
			while (true) {
				int alt1=2;
	...
	// proverif.g:12:1: declaration : ( 'type' ident proverifOptions | 'channel' ( ident ',' )* ident | 'free' ( ident ',' )* ident ':' typeid proverifOptions | 'const' ( ident ',' )* ident ':' typeid proverifOptions | 'fun' ident '(' ( ( typeid ',' )* typeid )? ')' ':' typeid proverifOptions | 'reduc' reduc proverifOptions | 'fun' ident '(' ( ( typeid ',' )* typeid )? ')' ':' typeid 'reduc' reducprime proverifOptions | 'equation' eqlist proverifOptions | 'pred' ident ( '(' ( ( typeid ',' )* typeid )? ')' )? proverifOptions | 'table' ident '(' ( ( typeid ',' )* typeid )? ')' | 'let' ident ( '(' ( typedecl )? ')' )? '=' process | 'set' name '=' value | 'event' ident ( '(' ( ( typeid ',' )* typeid )? ')' )? | 'query' ( typedecl ';' )? query | 'not' ( typedecl ';' )? gterm | 'nounif' ( typedecl ';' )? nounifdecl );
	public final void declaration() throws RecognitionException {
		try {
			// proverif.g:13:2: ( 'type' ident proverifOptions | 'channel' ( ident ',' )* ident | 'free' ( ident ',' )* ident ':' typeid proverifOptions | 'const' ( ident ',' )* ident ':' typeid proverifOptions | 'fun' ident '(' ( ( typeid ',' )* typeid )? ')' ':' typeid proverifOptions | 'reduc' reduc proverifOptions | 'fun' ident '(' ( ( typeid ',' )* typeid )? ')' ':' typeid 'reduc' reducprime proverifOptions | 'equation' eqlist proverifOptions | 'pred' ident ( '(' ( ( typeid ',' )* typeid )? ')' )? proverifOptions | 'table' ident '(' ( ( typeid ',' )* typeid )? ')' | 'let' ident ( '(' ( typedecl )? ')' )? '=' process | 'set' name '=' value | 'event' ident ( '(' ( ( typeid ',' )* typeid )? ')' )? | 'query' ( typedecl ';' )? query | 'not' ( typedecl ';' )? gterm | 'nounif' ( typedecl ';' )? nounifdecl )
			int alt22=16;
			switch ( input.LA(1) ) {
			case 70:
				{
			...
			switch (alt22) {
				case 1 :
					// proverif.g:13:4: 'type' ident proverifOptions
					{
				...
				case 2 :
					...
					break;
				case 3 :
					// proverif.g:15:4: 'free' ( ident ',' )* ident ':' typeid proverifOptions
					{
					match(input,46,FOLLOW_46_in_declaration70); if (state.failed) return;
					// proverif.g:15:11: ( ident ',' )*
					loop3:
					while (true) {
						int alt3=2;
					...
					break;
				case 4 :
					// proverif.g:16:4: 'const' ( ident ',' )* ident ':' typeid proverifOptions
					{
					match(input,38,FOLLOW_38_in_declaration90); if (state.failed) return;
					// proverif.g:16:12: ( ident ',' )*
					loop4:
					while (true) {
						int alt4=2;
					...
					break;
				case 5 :
					// proverif.g:17:4: 'fun' ident '(' ( ( typeid ',' )* typeid )? ')' ':' typeid proverifOptions
					{
					...
					// proverif.g:17:20: ( ( typeid ',' )* typeid )?
					int alt6=2;
					...
					switch (alt6) {
						case 1 :
							// proverif.g:17:21: ( typeid ',' )* typeid
							{
							// proverif.g:17:21: ( typeid ',' )*
							loop5:
							while (true) {
								int alt5=2;
					...
					break;
				case 6 :
					// proverif.g:18:4: 'reduc' reduc proverifOptions
					{
					...
					break;
				case 7 :
					// proverif.g:19:4: 'fun' ident '(' ( ( typeid ',' )* typeid )? ')' ':' typeid 'reduc' reducprime proverifOptions
					{
					...
					// proverif.g:19:20: ( ( typeid ',' )* typeid )?
					int alt8=2;
					...
					switch (alt8) {
						case 1 :
							// proverif.g:19:21: ( typeid ',' )* typeid
							{
							// proverif.g:19:21: ( typeid ',' )*
							loop7:
							while (true) {
								int alt7=2;
					...
					break;
				case 8 :
					// proverif.g:20:4: 'equation' eqlist proverifOptions
					{
					...
					break;
				case 9 :
					// proverif.g:21:4: 'pred' ident ( '(' ( ( typeid ',' )* typeid )? ')' )? proverifOptions
					{
					...
					state._fsp--;
					if (state.failed) return;
					// proverif.g:21:17: ( '(' ( ( typeid ',' )* typeid )? ')' )?
					int alt11=2;
					...
					switch (alt11) {
						case 1 :
							...
							switch (alt10) {
								case 1 :
									// proverif.g:21:24: ( typeid ',' )* typeid
									{
									// proverif.g:21:24: ( typeid ',' )*
									loop9:
									while (true) {
										int alt9=2;
					...
					break;
				case 10 :
					// proverif.g:22:4: 'table' ident '(' ( ( typeid ',' )* typeid )? ')'
					{
					...
					// proverif.g:22:22: ( ( typeid ',' )* typeid )?
					int alt13=2;
					...
					switch (alt13) {
						case 1 :
							// proverif.g:22:23: ( typeid ',' )* typeid
							{
							// proverif.g:22:23: ( typeid ',' )*
							loop12:
							while (true) {
								int alt12=2;
					...
					break;
				case 11 :
					// proverif.g:23:4: 'let' ident ( '(' ( typedecl )? ')' )? '=' process
					{
					...
					break;
				case 12 :
					// proverif.g:24:4: 'set' name '=' value
					{
					...
					break;
				case 13 :
					// proverif.g:25:4: 'event' ident ( '(' ( ( typeid ',' )* typeid )? ')' )?
					{
					...
					state._fsp--;
					if (state.failed) return;
					// proverif.g:25:18: ( '(' ( ( typeid ',' )* typeid )? ')' )?
					int alt18=2;
					...
					switch (alt18) {
						case 1 :
							...
							switch (alt17) {
								case 1 :
									// proverif.g:25:25: ( typeid ',' )* typeid
									{
									// proverif.g:25:25: ( typeid ',' )*
									loop16:
									while (true) {
										int alt16=2;
				...
				case 15 :
					...
					break;
				case 16 :
					// proverif.g:28:4: 'nounif' ( typedecl ';' )? nounifdecl
					{
					match(input,56,FOLLOW_56_in_declaration334); if (state.failed) return;
					// proverif.g:28:13: ( typedecl ';' )?
					int alt21=2;
	...
	// $ANTLR start "reduc"
	// proverif.g:31:1: reduc : ( 'forall' typedecl ';' )? term '=' term ( ';' reduc )? ;
	public final void reduc() throws RecognitionException {
		try {
			// proverif.g:32:2: ( ( 'forall' typedecl ';' )? term '=' term ( ';' reduc )? )
			// proverif.g:32:4: ( 'forall' typedecl ';' )? term '=' term ( ';' reduc )?
			{
			// proverif.g:32:4: ( 'forall' typedecl ';' )?
			int alt23=2;
			...
			switch (alt23) {
				case 1 :
					// proverif.g:32:5: 'forall' typedecl ';'
					{
	...
	// proverif.g:35:1: reducprime : ( 'forall' failtypedecl ';' )? ident '(' ( ( mayfailterm ',' )* mayfailterm )? ')' ( 'otherwise' reducprime )? ;
	public final void reducprime() throws RecognitionException {
		try {
			// proverif.g:36:2: ( ( 'forall' failtypedecl ';' )? ident '(' ( ( mayfailterm ',' )* mayfailterm )? ')' ( 'otherwise' reducprime )? )
			// proverif.g:36:4: ( 'forall' failtypedecl ';' )? ident '(' ( ( mayfailterm ',' )* mayfailterm )? ')' ( 'otherwise' reducprime )?
			{
			// proverif.g:36:4: ( 'forall' failtypedecl ';' )?
			int alt25=2;
			...
			switch (alt25) {
				case 1 :
					// proverif.g:36:5: 'forall' failtypedecl ';'
					{
			...
			// proverif.g:36:43: ( ( mayfailterm ',' )* mayfailterm )?
			int alt27=2;
			...
			switch (alt27) {
				case 1 :
					// proverif.g:36:44: ( mayfailterm ',' )* mayfailterm
					{
					// proverif.g:36:44: ( mayfailterm ',' )*
					loop26:
					while (true) {
						int alt26=2;
						switch ( input.LA(1) ) {
			...
			// proverif.g:36:81: ( 'otherwise' reducprime )?
			int alt28=2;
			...
			switch (alt28) {
				case 1 :
					// proverif.g:36:82: 'otherwise' reducprime
					{
	...
	// $ANTLR start "eqlist"
	// proverif.g:39:1: eqlist : ( 'forall' typedecl ';' ) term '=' term ( ';' eqlist )? ;
	public final void eqlist() throws RecognitionException {
		try {
			// proverif.g:40:2: ( ( 'forall' typedecl ';' ) term '=' term ( ';' eqlist )? )
			// proverif.g:40:4: ( 'forall' typedecl ';' ) term '=' term ( ';' eqlist )?
			{
			// proverif.g:40:4: ( 'forall' typedecl ';' )
			// proverif.g:40:5: 'forall' typedecl ';'
			{
	...
	// $ANTLR start "query"
	// proverif.g:51:1: query : ( gterm ( ';' query )? | 'putbegin' 'event' ':' ( ident ',' )* ident ( ';' query )? | 'putbegin' 'inj-event' ':' ( ident ',' )* ident ( ';' query )? );
	public final void query() throws RecognitionException {
		try {
			// proverif.g:52:2: ( gterm ( ';' query )? | 'putbegin' 'event' ':' ( ident ',' )* ident ( ';' query )? | 'putbegin' 'inj-event' ':' ( ident ',' )* ident ( ';' query )? )
			int alt35=3;
			...
			switch (alt35) {
				case 1 :
					// proverif.g:52:4: gterm ( ';' query )?
					{
					pushFollow(FOLLOW_gterm_in_query482);
					gterm();
					state._fsp--;
					if (state.failed) return;
					// proverif.g:52:10: ( ';' query )?
					int alt30=2;
					...
					break;
				case 2 :
					// proverif.g:53:4: 'putbegin' 'event' ':' ( ident ',' )* ident ( ';' query )?
					{
					...
					break;
				case 3 :
					// proverif.g:54:4: 'putbegin' 'inj-event' ':' ( ident ',' )* ident ( ';' query )?
					{
	...
	// $ANTLR start "gterm"
	// proverif.g:57:1: gterm : ( ident | ident '(' ( ( gterm ',' )* gterm )? ')' ( 'phase' integer )? | 'event' '(' ( ( gterm ',' )* gterm )? gterm ')' | 'inj-event' '(' ( ( gterm ',' )* gterm )? gterm ')' | '(' ( ( gterm ',' )* gterm )? gterm ')' | 'new' ident ( '[' ( gbinding )? ']' )? | 'let' ident '=' gterm 'in' gterm ) ( '=' gterm | '<>' gterm | '||' gterm | '&&' gterm | '==>' gterm )* ;
	public final void gterm() throws RecognitionException {
		try {
			// proverif.g:58:2: ( ( ident | ident '(' ( ( gterm ',' )* gterm )? ')' ( 'phase' integer )? | 'event' '(' ( ( gterm ',' )* gterm )? gterm ')' | 'inj-event' '(' ( ( gterm ',' )* gterm )? gterm ')' | '(' ( ( gterm ',' )* gterm )? gterm ')' | 'new' ident ( '[' ( gbinding )? ']' )? | 'let' ident '=' gterm 'in' gterm ) ( '=' gterm | '<>' gterm | '||' gterm | '&&' gterm | '==>' gterm )* )
			// proverif.g:58:4: ( ident | ident '(' ( ( gterm ',' )* gterm )? ')' ( 'phase' integer )? | 'event' '(' ( ( gterm ',' )* gterm )? gterm ')' | 'inj-event' '(' ( ( gterm ',' )* gterm )? gterm ')' | '(' ( ( gterm ',' )* gterm )? gterm ')' | 'new' ident ( '[' ( gbinding )? ']' )? | 'let' ident '=' gterm 'in' gterm ) ( '=' gterm | '<>' gterm | '||' gterm | '&&' gterm | '==>' gterm )*
			{
			// proverif.g:58:4: ( ident | ident '(' ( ( gterm ',' )* gterm )? ')' ( 'phase' integer )? | 'event' '(' ( ( gterm ',' )* gterm )? gterm ')' | 'inj-event' '(' ( ( gterm ',' )* gterm )? gterm ')' | '(' ( ( gterm ',' )* gterm )? gterm ')' | 'new' ident ( '[' ( gbinding )? ']' )? | 'let' ident '=' gterm 'in' gterm )
			int alt47=7;
			switch ( input.LA(1) ) {
			case ID:
				{
			...
			switch (alt47) {
				case 1 :
					...
					break;
				case 2 :
					// proverif.g:58:13: ident '(' ( ( gterm ',' )* gterm )? ')' ( 'phase' integer )?
					{
					...
					switch (alt37) {
						case 1 :
							// proverif.g:58:24: ( gterm ',' )* gterm
							{
							// proverif.g:58:24: ( gterm ',' )*
							loop36:
							while (true) {
								int alt36=2;
								switch ( input.LA(1) ) {
					...
					// proverif.g:58:49: ( 'phase' integer )?
					int alt38=2;
					...
					switch (alt38) {
						case 1 :
							// proverif.g:58:50: 'phase' integer
							{
				...
				case 3 :
					...
					switch (alt40) {
						case 1 :
							// proverif.g:58:83: ( gterm ',' )* gterm
							{
							// proverif.g:58:83: ( gterm ',' )*
							loop39:
							while (true) {
								int alt39=2;
								switch ( input.LA(1) ) {
				...
				case 4 :
					...
					switch (alt42) {
						case 1 :
							// proverif.g:58:133: ( gterm ',' )* gterm
							{
							// proverif.g:58:133: ( gterm ',' )*
							loop41:
							while (true) {
								int alt41=2;
								switch ( input.LA(1) ) {
					...
					break;
				case 5 :
					// proverif.g:58:166: '(' ( ( gterm ',' )* gterm )? gterm ')'
					{
					match(input,18,FOLLOW_18_in_gterm627); if (state.failed) return;
					// proverif.g:58:170: ( ( gterm ',' )* gterm )?
					int alt44=2;
					switch ( input.LA(1) ) {
						case ID:
							{
					...
					switch (alt44) {
						case 1 :
							// proverif.g:58:171: ( gterm ',' )* gterm
							{
							// proverif.g:58:171: ( gterm ',' )*
							loop43:
							while (true) {
								int alt43=2;
								switch ( input.LA(1) ) {
					...
					break;
				case 6 :
					// proverif.g:58:204: 'new' ident ( '[' ( gbinding )? ']' )?
					{
					...
					break;
				case 7 :
					// proverif.g:58:242: 'let' ident '=' gterm 'in' gterm
					{
			...
			// proverif.g:58:276: ( '=' gterm | '<>' gterm | '||' gterm | '&&' gterm | '==>' gterm )*
			loop48:
			while (true) {
				int alt48=6;
				switch ( input.LA(1) ) {
	...
	// proverif.g:61:1: gbinding : ( '!' integer '=' gterm ( ';' gbinding )? | ident '=' gterm ( ';' gbinding )? );
	public final void gbinding() throws RecognitionException {
		try {
			// proverif.g:62:3: ( '!' integer '=' gterm ( ';' gbinding )? | ident '=' gterm ( ';' gbinding )? )
			int alt51=2;
			...
			switch (alt51) {
				case 1 :
					// proverif.g:62:5: '!' integer '=' gterm ( ';' gbinding )?
					{
					...
					break;
				case 2 :
					// proverif.g:63:5: ident '=' gterm ( ';' gbinding )?
					{
	...
	// proverif.g:66:1: nounifdecl : ( 'let' ident '=' gformat 'in' nounifdecl | ident ( '(' ( ( gformat ',' )* gformat )? ')' ( 'phase' integer )? )? ( '/' integer )? );
	public final void nounifdecl() throws RecognitionException {
		try {
			// proverif.g:67:2: ( 'let' ident '=' gformat 'in' nounifdecl | ident ( '(' ( ( gformat ',' )* gformat )? ')' ( 'phase' integer )? )? ( '/' integer )? )
			int alt57=2;
			...
			switch (alt57) {
				case 1 :
					// proverif.g:67:4: 'let' ident '=' gformat 'in' nounifdecl
					{
					...
					break;
				case 2 :
					// proverif.g:68:4: ident ( '(' ( ( gformat ',' )* gformat )? ')' ( 'phase' integer )? )? ( '/' integer )?
					{
					pushFollow(FOLLOW_ident_in_nounifdecl778);
					ident();
					state._fsp--;
					if (state.failed) return;
					// proverif.g:68:10: ( '(' ( ( gformat ',' )* gformat )? ')' ( 'phase' integer )? )?
					int alt55=2;
					...
					switch (alt55) {
						case 1 :
							// proverif.g:68:11: '(' ( ( gformat ',' )* gformat )? ')' ( 'phase' integer )?
							{
							match(input,18,FOLLOW_18_in_nounifdecl781); if (state.failed) return;
							// proverif.g:68:15: ( ( gformat ',' )* gformat )?
							int alt53=2;
							...
							switch (alt53) {
								case 1 :
									// proverif.g:68:16: ( gformat ',' )* gformat
									{
									// proverif.g:68:16: ( gformat ',' )*
									loop52:
									while (true) {
										int alt52=2;
										switch ( input.LA(1) ) {
							...
							// proverif.g:68:45: ( 'phase' integer )?
							int alt54=2;
							...
							switch (alt54) {
								case 1 :
									// proverif.g:68:46: 'phase' integer
									{
	...
	// $ANTLR start "gformat"
	// proverif.g:71:1: gformat : ( ident | ident '(' ( ( gformat ',' )* gformat )? ')' | 'not' '(' ( ( gformat ',' )* gformat )? ')' | '(' ( ( gformat ',' )* gformat )? gformat ')' | 'new' ident ( '[' ( fbinding )? ']' )? | 'let' ident '=' gformat 'in' gformat );
	public final void gformat() throws RecognitionException {
		try {
			// proverif.g:72:2: ( ident | ident '(' ( ( gformat ',' )* gformat )? ')' | 'not' '(' ( ( gformat ',' )* gformat )? ')' | '(' ( ( gformat ',' )* gformat )? gformat ')' | 'new' ident ( '[' ( fbinding )? ']' )? | 'let' ident '=' gformat 'in' gformat )
			int alt66=6;
			switch ( input.LA(1) ) {
			case ID:
				{
			...
			switch (alt66) {
				case 1 :
					...
					break;
				case 2 :
					// proverif.g:73:4: ident '(' ( ( gformat ',' )* gformat )? ')'
					{
					...
					// proverif.g:73:14: ( ( gformat ',' )* gformat )?
					int alt59=2;
					...
					switch (alt59) {
						case 1 :
							// proverif.g:73:15: ( gformat ',' )* gformat
							{
							// proverif.g:73:15: ( gformat ',' )*
							loop58:
							while (true) {
								int alt58=2;
								switch ( input.LA(1) ) {
					...
					break;
				case 3 :
					// proverif.g:74:4: 'not' '(' ( ( gformat ',' )* gformat )? ')'
					{
					...
					// proverif.g:74:14: ( ( gformat ',' )* gformat )?
					int alt61=2;
					...
					switch (alt61) {
						case 1 :
							// proverif.g:74:15: ( gformat ',' )* gformat
							{
							// proverif.g:74:15: ( gformat ',' )*
							loop60:
							while (true) {
								int alt60=2;
								switch ( input.LA(1) ) {
					...
					break;
				case 4 :
					// proverif.g:75:4: '(' ( ( gformat ',' )* gformat )? gformat ')'
					{
					match(input,18,FOLLOW_18_in_gformat869); if (state.failed) return;
					// proverif.g:75:8: ( ( gformat ',' )* gformat )?
					int alt63=2;
					switch ( input.LA(1) ) {
						case ID:
							{
					...
					switch (alt63) {
						case 1 :
							// proverif.g:75:9: ( gformat ',' )* gformat
							{
							// proverif.g:75:9: ( gformat ',' )*
							loop62:
							while (true) {
								int alt62=2;
								switch ( input.LA(1) ) {
					...
					break;
				case 5 :
					// proverif.g:76:4: 'new' ident ( '[' ( fbinding )? ']' )?
					{
					...
					break;
				case 6 :
					// proverif.g:77:4: 'let' ident '=' gformat 'in' gformat
					{
	...
	// proverif.g:81:1: fbinding : ( '!' integer '=' gformat ( ';' fbinding )? | ident '=' gformat ( ';' fbinding )? );
	public final void fbinding() throws RecognitionException {
		try {
			// proverif.g:82:2: ( '!' integer '=' gformat ( ';' fbinding )? | ident '=' gformat ( ';' fbinding )? )
			int alt69=2;
			...
			switch (alt69) {
				case 1 :
					// proverif.g:82:4: '!' integer '=' gformat ( ';' fbinding )?
					{
					...
					break;
				case 2 :
					// proverif.g:83:5: ident '=' gformat ( ';' fbinding )?
					{
	...
	// $ANTLR start "clauses"
	// proverif.g:87:1: clauses : ( 'forall' failtypedecl ';' )? clause ( ';' clauses )? ;
	public final void clauses() throws RecognitionException {
		try {
			// proverif.g:88:2: ( ( 'forall' failtypedecl ';' )? clause ( ';' clauses )? )
			// proverif.g:88:4: ( 'forall' failtypedecl ';' )? clause ( ';' clauses )?
			{
			// proverif.g:88:4: ( 'forall' failtypedecl ';' )?
			int alt70=2;
			...
			switch (alt70) {
				case 1 :
					// proverif.g:88:5: 'forall' failtypedecl ';'
					{
	...
	// $ANTLR start "clause"
	// proverif.g:91:1: clause : ( term | term '->' term | term '<->' term | term '<=>' term );
	public final void clause() throws RecognitionException {
		try {
			// proverif.g:92:2: ( term | term '->' term | term '<->' term | term '<=>' term )
			int alt72=4;
			switch ( input.LA(1) ) {
			case 18:
				{
	...
	// $ANTLR start "process"
	// proverif.g:98:1: process : ( '0' | 'yield' | ident ( '(' ( ( pterm ',' )* pterm )? ')' )? | '(' process ')' | '!' process | '!' ident '<=' ident process | 'foreach' ident '<=' ident 'do' process | 'new' ident ( '[' ( ( ident ',' )* ident )? ']' )? ':' typeid ( ';' process )? | ident '<-R' typeid ( ';' process )? | 'if' pterm 'then' process ( 'else' process )? | 'in' '(' pterm ',' pattern ')' ( ';' process )? | 'out' '(' pterm ',' pterm ')' ( ';' process )? | 'let' pattern '=' pterm ( 'in' process ( 'else' process )? )? | ident ( ':' typeid )? '<-' pterm ( ';' process )? | 'let' typedecl 'suchthat' pterm ( 'in' process ( 'else' process )? )? | 'insert' ident '(' ( ( pterm ',' )* pterm )? ')' ( ';' process )? | 'get' ident '(' ( ( pattern ',' )* pattern )? ')' ( 'suchthat' pterm )? ( 'in' process ( 'else' process )? )? | 'event' ident ( '(' ( ( pterm ',' )* pterm )? ')' )? ( ';' process )? | 'phase' integer ( ';' process )? ) ( '|' process )* ;
	public final void process() throws RecognitionException {
		try {
			// proverif.g:99:2: ( ( '0' | 'yield' | ident ( '(' ( ( pterm ',' )* pterm )? ')' )? | '(' process ')' | '!' process | '!' ident '<=' ident process | 'foreach' ident '<=' ident 'do' process | 'new' ident ( '[' ( ( ident ',' )* ident )? ']' )? ':' typeid ( ';' process )? | ident '<-R' typeid ( ';' process )? | 'if' pterm 'then' process ( 'else' process )? | 'in' '(' pterm ',' pattern ')' ( ';' process )? | 'out' '(' pterm ',' pterm ')' ( ';' process )? | 'let' pattern '=' pterm ( 'in' process ( 'else' process )? )? | ident ( ':' typeid )? '<-' pterm ( ';' process )? | 'let' typedecl 'suchthat' pterm ( 'in' process ( 'else' process )? )? | 'insert' ident '(' ( ( pterm ',' )* pterm )? ')' ( ';' process )? | 'get' ident '(' ( ( pattern ',' )* pattern )? ')' ( 'suchthat' pterm )? ( 'in' process ( 'else' process )? )? | 'event' ident ( '(' ( ( pterm ',' )* pterm )? ')' )? ( ';' process )? | 'phase' integer ( ';' process )? ) ( '|' process )* )
			// proverif.g:99:4: ( '0' | 'yield' | ident ( '(' ( ( pterm ',' )* pterm )? ')' )? | '(' process ')' | '!' process | '!' ident '<=' ident process | 'foreach' ident '<=' ident 'do' process | 'new' ident ( '[' ( ( ident ',' )* ident )? ']' )? ':' typeid ( ';' process )? | ident '<-R' typeid ( ';' process )? | 'if' pterm 'then' process ( 'else' process )? | 'in' '(' pterm ',' pattern ')' ( ';' process )? | 'out' '(' pterm ',' pterm ')' ( ';' process )? | 'let' pattern '=' pterm ( 'in' process ( 'else' process )? )? | ident ( ':' typeid )? '<-' pterm ( ';' process )? | 'let' typedecl 'suchthat' pterm ( 'in' process ( 'else' process )? )? | 'insert' ident '(' ( ( pterm ',' )* pterm )? ')' ( ';' process )? | 'get' ident '(' ( ( pattern ',' )* pattern )? ')' ( 'suchthat' pterm )? ( 'in' process ( 'else' process )? )? | 'event' ident ( '(' ( ( pterm ',' )* pterm )? ')' )? ( ';' process )? | 'phase' integer ( ';' process )? ) ( '|' process )*
			{
			...
			switch (alt103) {
				...
				case 3 :
					...
					switch (alt75) {
						case 1 :
							...
							switch (alt74) {
								case 1 :
									// proverif.g:99:34: ( pterm ',' )* pterm
									{
									// proverif.g:99:34: ( pterm ',' )*
									loop73:
									while (true) {
										int alt73=2;
										switch ( input.LA(1) ) {
				...
				case 5 :
					...
					break;
				case 6 :
					// proverif.g:99:95: '!' ident '<=' ident process
					{
					...
					break;
				case 7 :
					// proverif.g:99:126: 'foreach' ident '<=' ident 'do' process
					{
					...
					break;
				case 8 :
					// proverif.g:99:168: 'new' ident ( '[' ( ( ident ',' )* ident )? ']' )? ':' typeid ( ';' process )?
					{
					...
					switch (alt78) {
						case 1 :
							...
							switch (alt77) {
								case 1 :
									// proverif.g:99:187: ( ident ',' )* ident
									{
									// proverif.g:99:187: ( ident ',' )*
									loop76:
									while (true) {
										int alt76=2;
					...
					break;
				case 9 :
					// proverif.g:99:244: ident '<-R' typeid ( ';' process )?
					{
					...
					break;
				case 10 :
					// proverif.g:99:281: 'if' pterm 'then' process ( 'else' process )?
					{
					...
					state._fsp--;
					if (state.failed) return;
					// proverif.g:99:307: ( 'else' process )?
					int alt81=2;
					...
					switch (alt81) {
						case 1 :
							// proverif.g:99:308: 'else' process
							{
					...
					break;
				case 11 :
					// proverif.g:99:328: 'in' '(' pterm ',' pattern ')' ( ';' process )?
					{
					...
					break;
				case 12 :
					// proverif.g:99:375: 'out' '(' pterm ',' pterm ')' ( ';' process )?
					{
					...
					break;
				case 13 :
					// proverif.g:99:419: 'let' pattern '=' pterm ( 'in' process ( 'else' process )? )?
					{
					...
					state._fsp--;
					if (state.failed) return;
					// proverif.g:99:443: ( 'in' process ( 'else' process )? )?
					int alt85=2;
					...
					switch (alt85) {
						case 1 :
							// proverif.g:99:444: 'in' process ( 'else' process )?
							{
							...
							state._fsp--;
							if (state.failed) return;
							// proverif.g:99:457: ( 'else' process )?
							int alt84=2;
							...
							switch (alt84) {
								case 1 :
									// proverif.g:99:458: 'else' process
									{
					...
					break;
				case 14 :
					// proverif.g:99:480: ident ( ':' typeid )? '<-' pterm ( ';' process )?
					{
					pushFollow(FOLLOW_ident_in_process1256);
					ident();
					state._fsp--;
					if (state.failed) return;
					// proverif.g:99:486: ( ':' typeid )?
					int alt86=2;
					...
					break;
				case 15 :
					// proverif.g:99:529: 'let' typedecl 'suchthat' pterm ( 'in' process ( 'else' process )? )?
					{
					...
					state._fsp--;
					if (state.failed) return;
					// proverif.g:99:561: ( 'in' process ( 'else' process )? )?
					int alt89=2;
					...
					switch (alt89) {
						case 1 :
							// proverif.g:99:562: 'in' process ( 'else' process )?
							{
							...
							state._fsp--;
							if (state.failed) return;
							// proverif.g:99:575: ( 'else' process )?
							int alt88=2;
							...
							switch (alt88) {
								case 1 :
									// proverif.g:99:576: 'else' process
									{
					...
					break;
				case 16 :
					// proverif.g:99:598: 'insert' ident '(' ( ( pterm ',' )* pterm )? ')' ( ';' process )?
					{
					...
					switch (alt91) {
						case 1 :
							// proverif.g:99:618: ( pterm ',' )* pterm
							{
							// proverif.g:99:618: ( pterm ',' )*
							loop90:
							while (true) {
								int alt90=2;
								switch ( input.LA(1) ) {
					...
					break;
				case 17 :
					// proverif.g:99:660: 'get' ident '(' ( ( pattern ',' )* pattern )? ')' ( 'suchthat' pterm )? ( 'in' process ( 'else' process )? )?
					{
					...
					// proverif.g:99:676: ( ( pattern ',' )* pattern )?
					int alt94=2;
					...
					switch (alt94) {
						case 1 :
							// proverif.g:99:677: ( pattern ',' )* pattern
							{
							// proverif.g:99:677: ( pattern ',' )*
							loop93:
							while (true) {
								int alt93=2;
								switch ( input.LA(1) ) {
					...
					// proverif.g:99:706: ( 'suchthat' pterm )?
					int alt95=2;
					...
					switch (alt95) {
						case 1 :
							// proverif.g:99:707: 'suchthat' pterm
							{
					...
					// proverif.g:99:726: ( 'in' process ( 'else' process )? )?
					int alt97=2;
					...
					switch (alt97) {
						case 1 :
							// proverif.g:99:727: 'in' process ( 'else' process )?
							{
							...
							state._fsp--;
							if (state.failed) return;
							// proverif.g:99:740: ( 'else' process )?
							int alt96=2;
							...
							switch (alt96) {
								case 1 :
									// proverif.g:99:741: 'else' process
									{
					...
					break;
				case 18 :
					// proverif.g:99:763: 'event' ident ( '(' ( ( pterm ',' )* pterm )? ')' )? ( ';' process )?
					{
					...
					switch (alt100) {
						case 1 :
							...
							switch (alt99) {
								case 1 :
									// proverif.g:99:783: ( pterm ',' )* pterm
									{
									// proverif.g:99:783: ( pterm ',' )*
									loop98:
									while (true) {
										int alt98=2;
										switch ( input.LA(1) ) {
					...
					break;
				case 19 :
					// proverif.g:99:828: 'phase' integer ( ';' process )?
					{
		...
		try {
			...
			switch (alt124) {
				...
				case 2 :
					...
					switch (alt106) {
						case 1 :
							// proverif.g:104:18: ( pterm ',' )* pterm
							{
							// proverif.g:104:18: ( pterm ',' )*
							loop105:
							while (true) {
								int alt105=2;
								switch ( input.LA(1) ) {
					...
					break;
				case 3 :
					// proverif.g:104:45: ident '(' ( ( pterm ',' )* pterm )? ')'
					{
					...
					switch (alt108) {
						case 1 :
							// proverif.g:104:56: ( pterm ',' )* pterm
							{
							// proverif.g:104:56: ( pterm ',' )*
							loop107:
							while (true) {
								int alt107=2;
								switch ( input.LA(1) ) {
					...
					break;
				case 4 :
					// proverif.g:104:83: 'choice' '[' pterm ',' pterm ']'
					{
				...
				case 5 :
					...
					break;
				case 6 :
					// proverif.g:104:140: 'new' ident ( '[' ( ( ident ',' )* ident )? ']' )? ':' typeid ';' pterm
					{
					...
					state._fsp--;
					if (state.failed) return;
					// proverif.g:104:152: ( '[' ( ( ident ',' )* ident )? ']' )?
					int alt111=2;
					...
					switch (alt111) {
						case 1 :
							// proverif.g:104:153: '[' ( ( ident ',' )* ident )? ']'
							{
							match(input,34,FOLLOW_34_in_pterm1512); if (state.failed) return;
							// proverif.g:104:157: ( ( ident ',' )* ident )?
							int alt110=2;
							...
							switch (alt110) {
								case 1 :
									// proverif.g:104:158: ( ident ',' )* ident
									{
									// proverif.g:104:158: ( ident ',' )*
									loop109:
									while (true) {
										int alt109=2;
					...
					break;
				case 7 :
					// proverif.g:104:208: ident '<-R' typeid ';' pterm
					{
					...
					break;
				case 8 :
					// proverif.g:104:239: 'if' pterm 'then' pterm ( 'else' pterm )?
					{
					...
					break;
				case 9 :
					// proverif.g:104:281: 'let' pattern
					{
					...
					break;
				case 10 :
					// proverif.g:104:297: ident ( ':' typeid )? '<-' pterm ';' pterm
					{
					pushFollow(FOLLOW_ident_in_pterm1575);
					ident();
					state._fsp--;
					if (state.failed) return;
					// proverif.g:104:303: ( ':' typeid )?
					int alt113=2;
					...
					break;
				case 11 :
					// proverif.g:104:340: 'let' typedecl 'suchthat' pterm 'in' pterm ( 'else' pterm )?
					{
					...
					break;
				case 12 :
					// proverif.g:104:401: 'insert' ident '(' ( ( pterm ',' )* pterm )? ')' ';' pterm
					{
					...
					// proverif.g:104:420: ( ( pterm ',' )* pterm )?
					int alt116=2;
					...
					switch (alt116) {
						case 1 :
							// proverif.g:104:421: ( pterm ',' )* pterm
							{
							// proverif.g:104:421: ( pterm ',' )*
							loop115:
							while (true) {
								int alt115=2;
								switch ( input.LA(1) ) {
					...
					break;
				case 13 :
					// proverif.g:104:458: 'get' ident '(' ( ( pattern ',' )* pattern )? ')' ( 'suchthat' pterm )? 'in' pterm ( 'else' pterm )?
					{
					...
					// proverif.g:104:474: ( ( pattern ',' )* pattern )?
					int alt118=2;
					...
					switch (alt118) {
						case 1 :
							// proverif.g:104:475: ( pattern ',' )* pattern
							{
							// proverif.g:104:475: ( pattern ',' )*
							loop117:
							while (true) {
								int alt117=2;
								switch ( input.LA(1) ) {
					...
					// proverif.g:104:504: ( 'suchthat' pterm )?
					int alt119=2;
					...
					switch (alt119) {
						case 1 :
							// proverif.g:104:505: 'suchthat' pterm
							{
					...
					break;
				case 14 :
					// proverif.g:104:553: 'event' ident ( '(' ( ( pterm ',' )* pterm )? ')' )? ';' pterm
					{
					...
					state._fsp--;
					if (state.failed) return;
					// proverif.g:104:567: ( '(' ( ( pterm ',' )* pterm )? ')' )?
					int alt123=2;
					...
					switch (alt123) {
						case 1 :
							// proverif.g:104:568: '(' ( ( pterm ',' )* pterm )? ')'
							{
							match(input,18,FOLLOW_18_in_pterm1686); if (state.failed) return;
							// proverif.g:104:572: ( ( pterm ',' )* pterm )?
							int alt122=2;
							...
							switch (alt122) {
								case 1 :
									// proverif.g:104:573: ( pterm ',' )* pterm
									{
									// proverif.g:104:573: ( pterm ',' )*
									loop121:
									while (true) {
										int alt121=2;
										switch ( input.LA(1) ) {
			...
			// proverif.g:104:611: ( '=' pterm | '<>' pterm | '&&' pterm | '||' pterm )*
			loop125:
			while (true) {
				int alt125=5;
				switch ( input.LA(1) ) {
	...
	// $ANTLR start "term"
	// proverif.g:108:1: term : ( '(' ( ( term ',' )* term )? ')' | ident '(' ( ( term ',' )* term )? ')' | 'not' '(' term ')' ) ( '=' term | '<>' term | '&&' term | '||' term )* ;
	public final void term() throws RecognitionException {
		try {
			// proverif.g:109:2: ( ( '(' ( ( term ',' )* term )? ')' | ident '(' ( ( term ',' )* term )? ')' | 'not' '(' term ')' ) ( '=' term | '<>' term | '&&' term | '||' term )* )
			// proverif.g:109:4: ( '(' ( ( term ',' )* term )? ')' | ident '(' ( ( term ',' )* term )? ')' | 'not' '(' term ')' ) ( '=' term | '<>' term | '&&' term | '||' term )*
			{
			// proverif.g:109:4: ( '(' ( ( term ',' )* term )? ')' | ident '(' ( ( term ',' )* term )? ')' | 'not' '(' term ')' )
			int alt130=3;
			switch ( input.LA(1) ) {
			case 18:
				{
			...
			switch (alt130) {
				case 1 :
					...
					switch (alt127) {
						case 1 :
							// proverif.g:109:10: ( term ',' )* term
							{
							// proverif.g:109:10: ( term ',' )*
							loop126:
							while (true) {
								int alt126=2;
								switch ( input.LA(1) ) {
					...
					break;
				case 2 :
					// proverif.g:109:35: ident '(' ( ( term ',' )* term )? ')'
					{
					...
					switch (alt129) {
						case 1 :
							// proverif.g:109:46: ( term ',' )* term
							{
							// proverif.g:109:46: ( term ',' )*
							loop128:
							while (true) {
								int alt128=2;
								switch ( input.LA(1) ) {
			...
			// proverif.g:109:91: ( '=' term | '<>' term | '&&' term | '||' term )*
			loop131:
			while (true) {
				int alt131=5;
				switch ( input.LA(1) ) {
	...
	// $ANTLR start "pattern"
	// proverif.g:130:1: pattern : ( ident | ident ':' typeid | '(' ( ( pattern ',' )* pattern )? ')' | ident '(' ( ( pattern ',' )* pattern )? ')' | '=' pterm );
	public final void pattern() throws RecognitionException {
		try {
			// proverif.g:131:3: ( ident | ident ':' typeid | '(' ( ( pattern ',' )* pattern )? ')' | ident '(' ( ( pattern ',' )* pattern )? ')' | '=' pterm )
			int alt136=5;
			switch ( input.LA(1) ) {
			case ID:
				{
			...
			switch (alt136) {
				...
				case 2 :
					...
					break;
				case 3 :
					// proverif.g:133:4: '(' ( ( pattern ',' )* pattern )? ')'
					{
					match(input,18,FOLLOW_18_in_pattern1848); if (state.failed) return;
					// proverif.g:133:8: ( ( pattern ',' )* pattern )?
					int alt133=2;
					...
					switch (alt133) {
						case 1 :
							// proverif.g:133:9: ( pattern ',' )* pattern
							{
							// proverif.g:133:9: ( pattern ',' )*
							loop132:
							while (true) {
								int alt132=2;
								switch ( input.LA(1) ) {
					...
					break;
				case 4 :
					// proverif.g:134:4: ident '(' ( ( pattern ',' )* pattern )? ')'
					{
					...
					// proverif.g:134:14: ( ( pattern ',' )* pattern )?
					int alt135=2;
					...
					switch (alt135) {
						case 1 :
							// proverif.g:134:15: ( pattern ',' )* pattern
							{
							// proverif.g:134:15: ( pattern ',' )*
							loop134:
							while (true) {
								int alt134=2;
								switch ( input.LA(1) ) {
	...
	// proverif.g:138:1: mayfailterm : ( term | 'fail' );
	public final void mayfailterm() throws RecognitionException {
		try {
			// proverif.g:139:2: ( term | 'fail' )
			int alt137=2;
	...
	// proverif.g:143:1: typedecl : ident ':' typeid ( ',' typedecl )? ;
	public final void typedecl() throws RecognitionException {
		try {
			// proverif.g:144:2: ( ident ':' typeid ( ',' typedecl )? )
			// proverif.g:144:4: ident ':' typeid ( ',' typedecl )?
			{
	...
	// proverif.g:147:1: failtypedecl : ident ':' typeid ( 'or' 'fail' )? ( ',' typedecl )? ;
	public final void failtypedecl() throws RecognitionException {
		try {
			// proverif.g:148:2: ( ident ':' typeid ( 'or' 'fail' )? ( ',' typedecl )? )
			// proverif.g:148:4: ident ':' typeid ( 'or' 'fail' )? ( ',' typedecl )?
			{
	...
	// proverif.g:151:1: proverifOptions : ( ( ident ',' )* ident )? ;
	public final void proverifOptions() throws RecognitionException {
		try {
			// proverif.g:152:2: ( ( ( ident ',' )* ident )? )
			// proverif.g:152:4: ( ( ident ',' )* ident )?
			{
			// proverif.g:152:4: ( ( ident ',' )* ident )?
			int alt142=2;
			...
			switch (alt142) {
				case 1 :
					// proverif.g:152:5: ( ident ',' )* ident
					{
					// proverif.g:152:5: ( ident ',' )*
					loop141:
					while (true) {
						int alt141=2;
	...
	// $ANTLR start "integer"
	// proverif.g:163:1: integer : INT ;
	public final void integer() throws RecognitionException {
		try {
			// proverif.g:164:2: ( INT )
			// proverif.g:164:4: INT
			{
